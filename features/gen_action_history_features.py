...
def build_action_history_features_wxr(df, action):
    # 一来缺少order_id这一列，而来第二个函数找不到。暂时不调用。
    features = pd.DataFrame({'userid': df['userid']})
...
def main():
    ...
    user_train = pd.read_csv(Configure.cleaned_path + 'cleaned_userProfile_train.csv', encoding='utf8', dtype={"userid":str})
    user_test = pd.read_csv(Configure.cleaned_path + 'cleaned_userProfile_test.csv', encoding='utf8', dtype={"userid":str})
    action_train = pd.read_csv(Configure.cleaned_path + 'cleaned_action_train.csv', dtype={"userid":str})
    action_test = pd.read_csv(Configure.cleaned_path + 'cleaned_action_test.csv', dtype={"userid":str})
    orderHistory_train = pd.read_csv(Configure.cleaned_path + 'cleaned_orderHistory_train.csv', encoding='utf8', dtype={"userid":str})
    orderHistory_test = pd.read_csv(Configure.cleaned_path + 'cleaned_orderHistory_test.csv', encoding='utf8', dtype={"userid":str})
    userComment_train = pd.read_csv(Configure.cleaned_path + 'cleaned_userComment_train.csv', encoding='utf8', dtype={"userid":str})
    userComment_test = pd.read_csv(Configure.cleaned_path + 'cleaned_userComment_test.csv', encoding='utf8', dtype={"userid":str})
    ...
    action_train = pd.read_csv(Configure.base_path + 'train/action_train.csv', dtype={"userid":str})
    action_test = pd.read_csv(Configure.base_path + 'test/action_test.csv', dtype={"userid":str})
    ...
    # 不知道这个baseline_features哪来的，给注释掉了
